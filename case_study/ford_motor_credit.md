...
\- Asset class: BOND, Instrument type: SR\_UNSECURED
...
| MAX\_LEVERAGE (Debt/EBITDA) | ≤ 6.5x | 4.1x | 🟢 GREEN | Comfortable buffer |

| MIN\_COVERAGE (Int. Coverage) | ≥ 1.5x | 3.6x | 🟢 GREEN | Well above floor |

| MAX\_DEBT\_ASSETS | ≤ 0.75 | 0.59 | 🟢 GREEN | Within limit |
